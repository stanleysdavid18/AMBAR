...
class AIManager:
    ...
    def __init__(self):
        ...
        # Las instancias se construyen una sola vez y el selector decide cuál
        # usar en cada consulta. Un cliente cloud sin clave queda inactivo.
        self.providers = {
    ...
    def generate(
        ...
        """
        Genera una respuesta usando el modo actual.
        """
        ...
        if text in [
            ...
            if name:
                ...
                response = f"Claro 😊 Tu nombre es {name}."

            else:

                response = "Todavía no sé cómo te llamas."
